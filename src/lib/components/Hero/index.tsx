  ...
  <section>
    <div id="hero" className="custom-screen pt-10 z-10 relative text-dark-blue">
      <div className="space-y-5 max-w-[70rem]  h-[25rem] mx-auto text-center flex flex-col justify-around ">
        ...
        Nós somos a <span className="text-gold">EJ</span> que irá transformar seu problema real em uma <span className="text-gold">solução</span> computacional{" "}
        </h1>
        <p className="max-w-[33rem] mx-auto mt-10 font-title font-medium text-[1rem]">
        <span className="text-blue">Setup</span><span className="text-gold">JR</span> simplifica a construção e o crescimento do seu projeto ou
